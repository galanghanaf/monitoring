...
class AssetDescription extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $config['base_url'] = site_url('superadmin/assetdescription/index');
    ...
    public function tambahData()
    {
        ...
        $this->load->view('templatesSuperAdmin/header', $data);
        $this->load->view('templatesSuperAdmin/sidebar');
        $this->load->view('superadmin/formTambahAssetDescription', $data);
        $this->load->view('templatesSuperAdmin/footer');
    }
    ...
    public function updateData($id)
    {
        ...
        $this->load->view('templatesSuperAdmin/header', $data);
        $this->load->view('templatesSuperAdmin/sidebar');
        $this->load->view('superadmin/formUpdateAssetDescription', $data);
        $this->load->view('templatesSuperAdmin/footer');
    }
