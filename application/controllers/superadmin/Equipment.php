...
class Equipment extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $config['base_url'] = site_url('superadmin/equipment/index');
        ...
        $this->load->view('superadmin/equipment', $data);
    ...
    public function tambahData()
    {
        ...
        $this->load->view('templatesSuperAdmin/header', $data);
        $this->load->view('templatesSuperAdmin/sidebar');
        $this->load->view('superadmin/formTambahEquipment', $data);
        $this->load->view('templatesSuperAdmin/footer');
    }
    ...
    public function updateData($id)
    {
        ...
        $this->load->view('templatesSuperAdmin/header', $data);
        $this->load->view('templatesSuperAdmin/sidebar');
        $this->load->view('superadmin/formUpdateEquipment', $data);
        $this->load->view('templatesSuperAdmin/footer');
    }
