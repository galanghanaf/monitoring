...
class Location extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $config['base_url'] = site_url('superadmin/location/index');
    ...
    public function tambahData()
    {
        ...
        $this->load->view('templatesSuperAdmin/header', $data);
        $this->load->view('templatesSuperAdmin/sidebar');
        $this->load->view('superadmin/formTambahLocation', $data);
        $this->load->view('templatesSuperAdmin/footer');
    }
    ...
    public function updateData($id)
    {
        ...
        $this->load->view('templatesSuperAdmin/header', $data);
        $this->load->view('templatesSuperAdmin/sidebar');
        $this->load->view('superadmin/formUpdateLocation', $data);
        $this->load->view('templatesSuperAdmin/footer');
    }
