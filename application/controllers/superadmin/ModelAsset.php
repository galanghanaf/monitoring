...
class ModelAsset extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $config['base_url'] = site_url('superadmin/modelasset/index');
        ...
        $this->load->view('superadmin/modelasset', $data);
    ...
    public function tambahData()
    {
        ...
        $this->load->view('templatesSuperAdmin/header', $data);
        $this->load->view('templatesSuperAdmin/sidebar');
        $this->load->view('superadmin/formTambahModelAsset', $data);
        $this->load->view('templatesSuperAdmin/footer');
    }
    public function tambahDataAksi()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect('superadmin/modelasset');
        }
    }
    ...
    public function updateData($id)
    {
        ...
        $this->load->view('templatesSuperAdmin/header', $data);
        $this->load->view('templatesSuperAdmin/sidebar');
        $this->load->view('superadmin/formUpdateModelAsset', $data);
        $this->load->view('templatesSuperAdmin/footer');
    }
    ...
    {
        $this->form_validation->set_rules('model', 'Model', 'required|trim|is_unique[model_asset.model]');
    }
