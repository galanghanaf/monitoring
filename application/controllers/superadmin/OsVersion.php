...
class OsVersion extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $config['base_url'] = site_url('superadmin/osversion/index');
        ...
        $this->load->view('superadmin/osversion', $data);
    ...
    public function tambahData()
    {
        ...
        $this->load->view('templatesSuperAdmin/header', $data);
        $this->load->view('templatesSuperAdmin/sidebar');
        $this->load->view('superadmin/formTambahOsVersion', $data);
        $this->load->view('templatesSuperAdmin/footer');
    }
    ...
    public function updateData($id)
    {
        ...
        $this->load->view('templatesSuperAdmin/header', $data);
        $this->load->view('templatesSuperAdmin/sidebar');
        $this->load->view('superadmin/formUpdateOsVersion', $data);
        $this->load->view('templatesSuperAdmin/footer');
    }
    ...
    {
        $this->form_validation->set_rules('osversion', 'OS Version', 'required');
    }
