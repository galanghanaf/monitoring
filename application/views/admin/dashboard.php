                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h4 mb-0 text-gray-800"><b>Monitoring App <b class="text-primary"><?php echo $title ?></b></b></h1>
                    </div>
                                    ...
                                    <script>
                                        ...
                                        <?php foreach ($mappingitotasset as $itot) : ?>
                                            L.marker([<?php echo $itot['latitude']; ?>, <?php echo $itot['longitude']; ?>]).addTo(map4)
                                                .bindPopup('Assets : <b><?php echo $itot['assets']; ?></b><br/>Plant Code : <b><?php echo $itot['plant_code']; ?></b><br/>CBU : <b><?php echo $itot['cbu']; ?></b><br/>Asset Number : <b><?php echo $itot['asset_number']; ?></b><br/>Asset Description : <b><?php echo $itot['asset_description']; ?></b><br/>Serial Number : <b><?php echo $itot['serial_number']; ?></b><br/>Model/Type : <b><?php echo $itot['model']; ?></b><br/>Computer Name : <b><?php echo $itot['computer_name']; ?></b><br/>Location : <b><?php echo $itot['location']; ?></b><br/><br/> <center><img src="<?php echo base_url() . 'assets/team/' . $itot['photo']; ?>" width="150px"></center> ');
                                        <?php endforeach; ?>
                                    </script>
                                    ...
                                    <div>
                                        ...
                                        <?php foreach ($topology as $l) : ?>
                                            ...
                                            <center>
                                                ...
                                                <iframe src="<?= base_url() . 'assets/team/' . $l['photo'] ?>" style="border: 0; width: 100%; height: 700px"></iframe>
                                            <?php endforeach; ?>
                                            </center>
