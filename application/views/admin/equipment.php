...
<div class="container-fluid">
    ...
    <a class="btn btn-sm btn-success mb-3" href="<?php echo base_url('admin/equipment/tambahData') ?>">
        <i class="fas fa-plus"> Add Data</i></a>
    <?php echo $this->session->flashdata('pesan') ?>
    <div class="row">
        <div class="col-md">
            <form action="<?= base_url('admin/equipment') ?>" method="POST">
    ...
    <table class=" table-hover table table-bordered">
        ...
        <?php foreach ($equipment as $e) : ?>
            <tr>
                ...
                <td>
                    <center>
                        <a class="btn btn-sm btn-warning" href="<?php echo base_url('admin/equipment/updateData/' . $e['id']) ?>">
                ...
                <td>
                    <center>
                        ...
                        <a onclick="return confirm('Konfirmasi Penghapusan Data')" class="btn btn-sm btn-danger" href="<?php echo base_url('admin/equipment/deleteData/' . $e['id']) ?>">
