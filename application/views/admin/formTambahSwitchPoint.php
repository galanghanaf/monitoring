                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <?php echo form_open_multipart('admin/switchpoint/tambahDataAksi') ?>
                            <form method="post" action="<?php echo base_url('admin/switchpoint/tambahDataAksi') ?>" enctype="multipart/form-data">
