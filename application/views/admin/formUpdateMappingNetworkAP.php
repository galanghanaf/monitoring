                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <?php foreach ($mappingnetworkap as $t) : ?>
                                ...
                                <?php echo form_open_multipart('admin/mappingnetworkap/updateDataAksi') ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pcb_serial_number" class="form-control" value="<?php echo $t->pcb_serial_number ?>">
                                    <?php echo form_error('pcb_serial_number', '<div class="text small text-danger"></div>') ?>
                                </div>
                                <div class="form-group">
                                    <label>Assembly Serial Number</label>
                                    <input type="text" name="assembly_serial_number" class="form-control" value="<?php echo $t->assembly_serial_number ?>">
