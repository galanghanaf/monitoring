...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md">
            <form action="<?= base_url('admin/location') ?>" method="POST">
    ...
    <table class=" table-hover table table-bordered">
        ...
        <?php foreach ($location as $l) : ?>
            <tr>
                ...
                <td>
                    <center>
                        <a class="btn btn-sm btn-warning" href="<?php echo base_url('admin/location/updateData/' . $l['id']) ?>">
                ...
                <td>
                    <center>
                        ...
                        <a onclick="return confirm('Konfirmasi Penghapusan Data')" class="btn btn-sm btn-danger" href="<?php echo base_url('admin/location/deleteData/' . $l['id']) ?>">
