                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        foreach ($portfolio1 as $p1) : ?>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a class="btn btn-sm btn-primary" href="<?php echo base_url('superadmin/dataPortfolio/updateData1/' . $p1['id_portfolio']) ?>">
                        ...
                        foreach ($portfolio2 as $p2) : ?>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a class="btn btn-sm btn-primary" href="<?php echo base_url('superadmin/dataPortfolio/updateData2/' . $p2['id_portfolio']) ?>">
                                            <i class="fas fa-edit"></i></a>
                                    </center>
                                </td>
                            </tr>
                        ...
                        foreach ($portfolio3 as $p3) : ?>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a class="btn btn-sm btn-primary" href="<?php echo base_url('superadmin/dataPortfolio/updateData3/' . $p3['id_portfolio']) ?>">
                                            <i class="fas fa-edit"></i></a>
                                    </center>
                                </td>
                            </tr>
                        ...
                        foreach ($portfolio4 as $p4) : ?>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a class="btn btn-sm btn-primary" href="<?php echo base_url('superadmin/dataPortfolio/updateData4/' . $p3['id_portfolio']) ?>">
                                            <i class="fas fa-edit"></i></a>
                                    </center>
                                </td>
                            </tr>
                        ...
                        foreach ($portfolio5 as $p5) : ?>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a class="btn btn-sm btn-primary" href="<?php echo base_url('superadmin/dataPortfolio/updateData5/' . $p5['id_portfolio']) ?>">
                                            <i class="fas fa-edit"></i></a>
                                    </center>
                                </td>
                            </tr>
                        ...
                        foreach ($portfolio6 as $p6) : ?>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a class="btn btn-sm btn-primary" href="<?php echo base_url('superadmin/dataPortfolio/updateData6/' . $p6['id_portfolio']) ?>">
                                            <i class="fas fa-edit"></i></a>
                                    </center>
                                </td>
                            </tr>
