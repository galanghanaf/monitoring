                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <?php echo form_open_multipart('superadmin/itotasset/tambahDataAksi') ?>
                            <form method="post" action="<?php echo base_url('superadmin/itotasset/tambahDataAksi') ?>" enctype="multipart/form-data">
