                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <?php echo form_open_multipart('superadmin/logbook/tambahDataAksi') ?>
                            <form method="post" action="<?php echo base_url('superadmin/logbook/tambahDataAksi') ?>" enctype="multipart/form-data">
