                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <?php echo form_open_multipart('superadmin/mappingnetworkap/tambahDataAksi') ?>
                            <form method="post" action="<?php echo base_url('superadmin/mappingnetworkap/tambahDataAksi') ?>" enctype="multipart/form-data">
