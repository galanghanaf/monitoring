                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <?php echo form_open_multipart('superadmin/switchpoint/tambahDataAksi') ?>
                            <form method="post" action="<?php echo base_url('superadmin/switchpoint/tambahDataAksi') ?>" enctype="multipart/form-data">
