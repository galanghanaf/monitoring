                    ...
                    <div class="card">
                        <div class="card-body">
                            <?php foreach ($team4 as $t4) : ?>
                                ...
                                <?php echo form_open_multipart('superadmin/dataTeam/updateDataAksi4') ?>
                                <div class="form-group">
                                    <label>Nama</label>
                                    <input type="hidden" name="id_team" class="form-control" value="<?php echo $t4->id_team ?>">
                                    <input type="text" name="nama" class="form-control" value="<?php echo $t4->nama ?>">
                                ...
                                <div class="form-group">
                                    <label>NPM</label>
                                    <input type="number" name="npm" class="form-control" value="<?php echo $t4->npm ?>">
                                    <!-- function rules kita panggil dengan form_error, untuk menampilkan pesan masalahnya-->
                                    <?php echo form_error('npm', '<div class="text small text-danger"></div>') ?>
                                </div>
                                <div class="form-group">
                                    <label>Photo</label>
                                    <input type="file" name="photo" class="form-control" value="<?php echo $t4->photo ?>">
                                    <!-- function rules kita panggil dengan form_error, untuk menampilkan pesan masalahnya-->
