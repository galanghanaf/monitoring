...
<div class="container-fluid">
    ...
    <a class="btn btn-sm btn-success mb-3" href="<?php echo base_url('superadmin/logbook/tambahData') ?>">
        <i class="fas fa-plus"> Add Data</i></a>
    <a class="btn btn-sm btn-primary mb-3 float-right" href="<?php echo base_url('superadmin/logbook/export_csv') ?>">
        <i class="fas fa-download"> Export CSV</i></a>
    <?php echo $this->session->flashdata('pesan') ?>
    <div class="row">
        <div class="col-md">
            <form action="<?= base_url('superadmin/logbook') ?>" method="POST">
    ...
    <table style="white-space:nowrap;" class="table-responsive table-hover table table-bordered" style="overflow-y: scroll; overflow-x: auto">
        ...
        <?php foreach ($logbook as $l) : ?>
            <tr>
                ...
                <td>
                    <center>
                        <a class="btn btn-sm btn-warning" href="<?php echo base_url('superadmin/logbook/updateData/' . $l['id']) ?>">
                ...
                <td>
                    <center>
                        ...
                        <a onclick="return confirm('Konfirmasi Penghapusan Data')" class="btn btn-sm btn-danger" href="<?php echo base_url('superadmin/logbook/deleteData/' . $l['id']) ?>">
