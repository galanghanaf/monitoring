...
<div class="container-fluid">
    ...
    <a class="btn btn-sm btn-success mb-3" href="<?php echo base_url('superadmin/mappingnetworkap/tambahData') ?>">
        <i class="fas fa-plus"> Add Data</i></a>
    <?php echo $this->session->flashdata('pesan') ?>
    <div class="row">
        <div class="col-md">
            <form action="<?= base_url('superadmin/mappingnetworkap') ?>" method="POST">
        ...
        <?php foreach ($mappingnetworkap as $l) : ?>
            <tr>
                ...
                <td class="text-center">
                    <center>
                        <a class="btn btn-sm btn-warning" href="<?php echo base_url('superadmin/mappingnetwork/updateData/' . $l['id']) ?>">
                ...
                <td class="text-center">
                    <center>
                        ...
                        <a onclick="return confirm('Konfirmasi Penghapusan Data')" class="btn btn-sm btn-danger" href="<?php echo base_url('superadmin/mappingnetwork/deleteData/' . $l['id']) ?>">
