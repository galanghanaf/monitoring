                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        foreach ($team1 as $t1) : ?>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a class="btn btn-sm btn-primary" href="<?php echo base_url('superadmin/datateam/updateData1/' . $t1['id_team']) ?>">
                        ...
                        foreach ($team2 as $t2) : ?>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a class="btn btn-sm btn-primary" href="<?php echo base_url('superadmin/datateam/updateData2/' . $t2['id_team']) ?>">
                                            <i class="fas fa-edit"></i></a>
                                    </center>
                                </td>
                            </tr>
                        ...
                        foreach ($team3 as $t3) : ?>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a class="btn btn-sm btn-primary" href="<?php echo base_url('superadmin/datateam/updateData3/' . $t3['id_team']) ?>">
                                            <i class="fas fa-edit"></i></a>
                                    </center>
                                </td>
                            </tr>
                        ...
                        foreach ($team4 as $t4) : ?>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a class="btn btn-sm btn-primary" href="<?php echo base_url('superadmin/datateam/updateData4/' . $t4['id_team']) ?>">
                                            <i class="fas fa-edit"></i></a>
                                    </center>
                                </td>
                            </tr>
                        ...
                        foreach ($team5 as $t5) : ?>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a class="btn btn-sm btn-primary" href="<?php echo base_url('superadmin/datateam/updateData5/' . $t5['id_team']) ?>">
                                            <i class="fas fa-edit"></i></a>
                                    </center>
                                </td>
                            </tr>
