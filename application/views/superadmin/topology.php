                ...
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <?php foreach ($topology as $l) : ?>
                            <a class="btn btn-sm btn-success mb-3 ml-2" href="<?php echo base_url('superadmin/topology/updateData2/' . $l['id']) ?>">
                                <i class="fas fa-plus"></i> Make Your Own Topology</a>
                            <a class="btn btn-sm btn-primary mb-3 ml-2" href="<?php echo base_url('superadmin/topology/updateData/' . $l['id']) ?>">
